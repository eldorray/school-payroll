    ...
    <x-ui.card class="mb-6">
        <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
            ...
            <form action="{{ route('backups.restore') }}" method="POST" enctype="multipart/form-data"
                ...
                onsubmit="return confirm('PERINGATAN: Ini akan mengganti semua data saat ini dengan data dari backup. Lanjutkan?');">
                @csrf
                <input type="file" name="backup_file" accept=".sql" class="input" required>
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="font-medium text-[hsl(var(--foreground))]">{{ $backup['filename'] }}</span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form action="{{ route('backups.restore') }}" method="POST" class="inline-block"
                                            onsubmit="return confirm('PERINGATAN: Ini akan mengganti semua data saat ini. Lanjutkan restore dari {{ $backup['filename'] }}?');">
                                            @csrf
