...
@section('content')
    <h2 class="text-2xl font-bold mb-6">Create Academic Year</h2>
    ...
    <div class="bg-white p-6 rounded-lg shadow max-w-2xl">
        <form action="{{ route('academic-years.store') }}" method="POST">
            ...
            <hr class="my-6">
            <h3 class="text-lg font-bold mb-4">Payroll Settings (Standard Rates)</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="teaching_rate" id="teaching_rate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0">
                </div>
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="transport_rate">
                        Transport Rate / Visit
                    </label>
                    <input type="number" name="transport_rate" id="transport_rate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0">
                </div>
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="masa_kerja_rate">
                        Masa Kerja Rate / Year
                    </label>
                    <input type="number" name="masa_kerja_rate" id="masa_kerja_rate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0">
                </div>
            </div>
