    ...
    <x-ui.card>
        ...
        @if($teachers->isEmpty())
            <x-ui.alert variant="warning" class="mb-6">
                <p>Tidak ada guru tahfidz yang aktif. Silakan tandai guru sebagai "Tahfidz" di halaman <a href="{{ route('teachers.index') }}" class="underline">Daftar Guru</a>.</p>
            </x-ui.alert>
        @else
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input type="number" name="attendance[{{ $teacher->id }}][deductions][late_count]" class="input w-16 text-center text-[hsl(var(--destructive))]" min="0" placeholder="0" title="Jumlah keterlambatan">
                                </td>
                                <td class="text-center">
