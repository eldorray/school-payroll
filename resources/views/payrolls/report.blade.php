                ...
                @php
                    ...
                    foreach ($allowancesMap as $name => $amount) {
                        ...
                        if (str_contains($n, 'media center')) {
                            ...
                            str_contains($n, 'wakbid') ||
                            str_contains($n, 'wakil') ||
                            str_contains($n, 'waka') ||
                            str_contains($n, 'kurikulum') ||
                            str_contains($n, 'kesiswaan') ||
                            str_contains($n, 'humas') ||
                            str_contains($n, 'sarpras')
                        ) {
                            $wakbid += $amount;
